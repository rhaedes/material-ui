...
class InternalSearchTermItemListComponent extends Component {
    ...
    render() {
        ...
        return (
            <div style={{ lineHeight: '66px', borderBottom: '1px solid #000' }} className="row">
...
class InternalSearchTermListComponent extends Component {
    render() {
        const { internalSearchTerms, onDelete, onUpdateSearchTerm } = this.props;
...
class InternalSearchTermComponent extends Component {
    ...
    render() {
        ...
        return (<div>
            ...
            <div style={spacingStyle}>
                <InternalSearchTermListComponent onUpdateSearchTerm={debounce(this.props.updateInternalSearchTerm, 200) } onDelete={this.onDeleteHandler.bind(this) } internalSearchTerms={this.props.search.internalSearchTerms}></InternalSearchTermListComponent>
            </div>
        </div>)
    }
}
