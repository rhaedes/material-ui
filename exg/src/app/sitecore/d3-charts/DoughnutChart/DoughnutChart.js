...
class Tabs extends Component {
  static propTypes = {
    ...
    isColorPaletteShaded:PropTypes.boolean,
    isLegendHidden: PropTypes.boolean,
    sortByValue: PropTypes.boolean,
    maxNumberOfSegments: PropTypes.number,
    otherText: PropTypes.string,
    itemClicked: PropTypes.func,
    isValueShown: PropTypes.boolean,
    allCategoriesLabel: PropTypes.string,
    valueDescriptionLabel: PropTypes.string,
    isSegmentTooltipVisible: PropTypes.boolean,
    categoryInformation: PropTypes.string,
    isValueConvertedToPercent: PropTypes.boolean,
    isCalloutLabelWithValue: PropTypes.boolean,
    isCalloutValueConvertedToPercent: PropTypes.boolean,
    seriesDefinitions: PropTypes.object,
    xNumberScale: PropTypes.string,
    xNumberScaleValues: PropTypes.string,
    xNumberScaleUnits: PropTypes.string,
    yNumberScale: PropTypes.string,
    yNumberScaleValues: PropTypes.string,
    yNumberScaleUnits: PropTypes.string,
    isSegmentSelectionDisabled: PropTypes.boolean
  };

  static defaultProps = {
    el : ,
    legendMode: "MultipleCheck",
    isTitleVisible: true,    
    ...
    valueDescriptionLabel: "bananas",
    isSegmentTooltipVisible: false,
    categoryInformation: "Legend",
    isValueConvertedToPercent: false,
    isCalloutLabelWithValue: false,
    isCalloutValueConvertedToPercent: false,
    seriesDefinitions = {},
    xNumberScale,
    xNumberScaleValues,
    xNumberScaleUnits,
  ...
  componentDidMount() {
    this.refs.doughnutChart.getDOMNode().setAttribute('data-sc-id', 'Doughnut1');
  }
  ...
  handleItemClick = (d) => {
    this.props.selectedItem  =  d;
    //this.model.trigger("ItemSelected", d);
  };

  refresh = (isAnimationEnabled) => {
  ...
  render() {
    const {
        ...
        isSegmentTooltipVisible,
        categoryInformation,
        isValueConvertedToPercent,
        isCalloutLabelWithValue,
        isCalloutValueConvertedToPercent,
        seriesDefinitions,
        xNumberScale,
        xNumberScaleValues,
        xNumberScaleUnits,
...
//       }, this);
    ...
    return (
      ...
      >            
        <div class="chart-title sc-text x-large">this.props.title</div>            
